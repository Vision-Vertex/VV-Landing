...
function Hero() {
  ...
  return (
    <section className="relative min-h-screen lg:h-screen bg-gradient-to-br from-primary via-secondary to-primary overflow-hidden">
      {/* Navbar */}
      <div className="flex justify-between items-center w-full p-4 md:px-14 md:py-7 relative z-50">
        ...
        <div className="hidden sm:flex gap-10">
          ...
          <Button variant={'outline'} className="border-white/30 text-white bg-white/10 hover:bg-white/20 hover:text-primary backdrop-blur-sm">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 h-full flex items-center overflow-hidden">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-12 items-center w-full h-full">
          ...
          >
            ...
            >
              We're your partner in software engineering, cloud & DevOps, AI & data science, and training & R&D. From full-stack development to cutting-edge AI solutions.
            </motion.p>
            ...
            >
              ...
              <Button variant="outline" className="border-white/30 text-white bg-white/10 px-5 py-2.5 md:px-6 md:py-3 rounded-xl text-sm md:text-base font-semibold backdrop-blur-sm transition-all duration-300">
          ...
          >
            ...
            <div className="relative z-10 flex items-center justify-center">
              <motion.div
                ...
                className="relative"
              >
                <Image src={V} alt="V" width={120} height={120} className="drop-shadow-2xl" />
                <motion.div
              ...
              <motion.div
                ...
                className="relative"
              >
                <Image src={I2} alt="I" width={25} height={25} className="drop-shadow-lg" />
              </motion.div>
              ...
              <motion.div
                ...
                className="relative"
              >
                <Image src={S} alt="S" width={180} height={180} className="drop-shadow-2xl" />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-secondary-400/30 to-primary-400/30 rounded-full blur-xl"
                  animate={{
                    scale: [1, 1.1, 1],
          ...
          <motion.div
            ...
            animate={{ y: 0, opacity: 1 }}
                ...
                className="relative"
          >
                <Image src={I} alt="I" width={25} height={25} className="drop-shadow-lg" />
          </motion.div>
          ...
          <motion.div
            ...
            animate={{ scale: 1, opacity: 1 }}
                ...
                className="relative"
              >
                <Image src={O} alt="O" width={150} height={150} className="drop-shadow-2xl" />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-secondary-400/30 to-primary-400/30 rounded-full blur-xl"
                  animate={{
                    scale: [1, 1.15, 1],
          ...
          <motion.div
            ...
            animate={{ x: 0, opacity: 1 }}
                ...
                className="relative"
              >
                <Image src={N} alt="N" width={105} height={105} className="drop-shadow-2xl" />
                <motion.div
                  className="absolute inset-0 bg-gradient-to-r from-secondary-400/30 to-primary-400/30 rounded-full blur-xl"
                  animate={{
                    scale: [1, 1.1, 1],
