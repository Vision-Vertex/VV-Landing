    ...
    <section className="relative bg-white py-16 overflow-hidden">
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 md:px-14">
        ...
        >
          ...
          >
            From software engineering to AI & data science, our specialized services deliver comprehensive solutions that drive innovation and business growth.
          </motion.p>
        </motion.div>
              ...
              <div className={`grid gap-8 items-center ${
                ...
                <div className="space-y-6">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="text-primary font-medium text-sm">Premium Service</p>
                    </div>
                </div>
                ...
                />
                  ...
                  <div className={`grid gap-3 ${
                    ...
                    {service.cards?.slice(0, index === 0 ? 2 : 2).map((card, cardIndex) => (
                      <motion.div
                        key={cardIndex}
                      ...
                      >
                        ...
                        <div>
                          ...
                          <p className="text-xs text-gray-600">{card.description.length > 50 ? card.description.substring(0, 50) + '...' : card.description}</p>
                        </div>
                      </motion.div>
                    ))}
                </div>
