                ...
                <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-center">
                  <div>
                    ...
                    <h3 className="text-xl font-bold text-white mb-4">
                      {service.cards[3].title}
                    </h3>
                    <p className="text-white/90 leading-relaxed mb-6">
                      {service.cards[3].description}
                      <br />
                      <br />
                      Leverage global time zones to keep your projects moving
                      around the clock.
                    </p>
                    <motion.div
                      whileHover={{ scale: 1.05 }}
            ...
            >
              {[
                ...
                },
                {
                  ...
                  title: "Planning",
                  description:
                    "Our team develops a comprehensive strategy and project roadmap with clear milestones.",
                ...
                >
                  ...
                  <div className="relative mb-6">
                    <div
                      className={`w-16 h-16 bg-gradient-to-r ${process.color} rounded-2xl flex items-center justify-center shadow-lg`}
                    >
                      {process.icon}
                    </div>
                    <div
                      className={`absolute top-0 right-0 w-20 h-20 bg-gradient-to-br ${process.color.replace(
                        "to-",
                        "to-"
